...
public class MiniPekka extends SingleTargetTroop {
	...
	private final String RUN_ANIMATION_LEFT_PATH = "" /*"/assets/sprites/mini_pekka/mini_pekka_run_left.png"*/ ;
	private final String RUN_ANIMATION_RIGHT_PATH = "" /*"/assets/sprites/mini_pekka/mini_pekka_run_right.png"*/ ;
	private final String BATTLE_ANIMATION_FIRST_PATH = "" /*"/assets/sprites/mini_pekka/mini_pekka_battle_first.png"*/ ;
	private final String BATTLE_ANIMATION_SECOND_PATH = "" /*"/assets/sprites/mini_pekka/mini_pekka_battle_second.png"*/ ;
	// Constructor
	public MiniPekka() {
