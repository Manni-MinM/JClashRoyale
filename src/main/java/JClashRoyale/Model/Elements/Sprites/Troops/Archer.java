...
public class Archer extends SingleTargetTroop {
	...
	private final String RED_RUN_ANIMATION_LEFT_PATH = "/assets/sprites/archer/archer_red_run_left.png" ;
	private final String RED_RUN_ANIMATION_RIGHT_PATH = "/assets/sprites/archer/archer_red_run_right.png" ;
	private final String BLUE_RUN_ANIMATION_LEFT_PATH = "/assets/sprites/archer/archer_blue_run_left.png" ;
	private final String BLUE_RUN_ANIMATION_RIGHT_PATH = "/assets/sprites/archer/archer_blue_run_right.png" ;
	private final String RED_BATTLE_ANIMATION_FIRST_PATH = "" /*"/assets/sprites/archer/archer_red_battle_first.png"*/ ;
	private final String RED_BATTLE_ANIMATION_SECOND_PATH = "" /*"/assets/sprites/archer/archer_red_battle_second.png"*/ ;
	private final String BLUE_BATTLE_ANIMATION_FIRST_PATH = "" /*"/assets/sprites/archer/archer_blue_battle_first.png"*/ ;
	private final String BLUE_BATTLE_ANIMATION_SECOND_PATH = "" /*"/assets/sprites/archer/archer_blue_battle_second.png"*/ ;
	// Constructor
	public Archer() {
